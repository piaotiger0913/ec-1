###########################################################################
## Makefile generated for component 'cal_corr'. 
## 
## Makefile     : cal_corr_rtw.mk
## Generated on : Fri Jul 01 19:06:19 2022
## Final product: ./cal_corr.lib
...
PRODUCT_NAME              = cal_corr
MAKEFILE                  = cal_corr_rtw.mk
MATLAB_ROOT               = E:/Program Files/Polyspace/R2021a
MATLAB_BIN                = E:/Program Files/Polyspace/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/codegen/lib/cal_corr
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = cal_corr_rtw_comp.rsp
CMD_FILE                  = cal_corr_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = cal_corr.lib
...
DEFINES_STANDARD = -DMODEL=cal_corr
...
SRCS = $(START_DIR)/cal_corr_data.c $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/cal_corr_initialize.c $(START_DIR)/cal_corr_terminate.c $(START_DIR)/cal_corr.c $(START_DIR)/fft.c $(START_DIR)/FFTImplementationCallback.c $(START_DIR)/cal_corr_emxutil.c $(START_DIR)/cal_corr_emxAPI.c
...
OBJS = cal_corr_data.o rt_nonfinite.o rtGetNaN.o rtGetInf.o cal_corr_initialize.o cal_corr_terminate.o cal_corr.o fft.o FFTImplementationCallback.o cal_corr_emxutil.o cal_corr_emxAPI.o
...
cal_corr_data.o : $(START_DIR)/cal_corr_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
cal_corr_initialize.o : $(START_DIR)/cal_corr_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cal_corr_terminate.o : $(START_DIR)/cal_corr_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cal_corr.o : $(START_DIR)/cal_corr.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
cal_corr_emxutil.o : $(START_DIR)/cal_corr_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


cal_corr_emxAPI.o : $(START_DIR)/cal_corr_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
